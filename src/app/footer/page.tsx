...
function Footer() {
  return <div className={`bg-green-600 text-white`}>
      <div className={`${Style.container} mx-auto px-4 py-12`}>
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div >
              ...
              <p className={`${Style.box} text-green-100 mb-4`}>
                Phần mềm quản lý đa ngành nghề hàng đầu Việt Nam. Tích hợp AI, mobile app và hệ thống CRM hoàn chỉnh.
              </p>
              <div className=" h-25 flex space-x-4">
                <a href="#" aria-label="Facebook" className="text-green-100 hover:text-white">
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="#" aria-label="Twitter" className={`${Style.icon} text-green-100 hover:text-white`}>
                  <i className="fab fa-twitter"></i>
                </a>
                <a href="#" aria-label="LinkedIn" className={`${Style.icon} text-green-100 hover:text-white`}>
            ...
            <div >
              ...
              <ul className="space-y-2">
                ...
                <li className={`${Style.item2} flex items-center text-white text-lg`}>
          ...
          <div className={`${Style.copyright} border-t border-green-500 mt-8 pt-8 text-center text-green-100`}>
