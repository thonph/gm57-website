...
export default function OpportunitiesSection() {
    const [section, setSection] = useState<OpportunitiesSection | null>(null);
    const [items, setItems] = useState<OpportunitiesItems[]>([]);
        ...
        const fetchData = async () => {
            try {
                ...
                const [sectionRes, itemsRes,] = await Promise.all([
                    httpGet<{ message: string; data: OpportunitiesSection[] }>("opportunities_section"),
                    httpGet<{ message: string; data: OpportunitiesItems[] }>("opportunities_items"),
                ]);
        ...
        <div className="container mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p className="text-lg text-black mb-8">{section.opportunities_subtitle}</p>
                ...
                <div className="space-y-8">
                    <img
                        src={imageUrl}
                        alt={section.opportunities_title}
